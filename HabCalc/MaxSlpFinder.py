...
#chtmp,udx = np.unique(chandat[:,0],return_index=True)
#chandat = chandat[udx,:]
...
f.write('UNIQUE_ID,type,catchmentID,habitat_sqkm,habitatSegment_sqkm,functional_habitatSegment_sqkm,PassageToHabitat,Decision,TERMCODE,terminal_name_huc10,terminal_name_huc8,terminal_name_huc6,terminal_name_huc4,dam_name,latitude,longitude,dam_order\n')
for i in idx:
    f.write('%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s\n'
        % (IDs[i], type[i], dams_outs[i], habup[i], habseg[i], habseg[i]*passageComp[i], passageComp[i], decision[i],
